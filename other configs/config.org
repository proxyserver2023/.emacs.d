...
#+END_SRC
* TODO A Secure Emacs Environment
...
#+END_SRC
* benchmarking
_source_: [[https://github.com/purcell/emacs.d/blob/master/lisp/init-benchmarking.el]]
#+BEGIN_SRC emacs-lisp
...
| File                | Desc                                                       |
|---------------------+------------------------------------------------------------|
| organizer.org       | main org; inbox for M-x org-capture, tasks, weekly reviews |
| investing.org       | invest related notes                                       |
| people.org          | people related notes                                       |
| long-term-plans.org | long term plans                                            |
| decissions.org      | pending, current and reviewed decissions                   |
| blog.org            | topic index for my blog                                    |
| learning.org        | learning plan                                              |
| tracking.org        | temp org file for tracking various files                   |
...
|---------------------+------------------------------------------------------------|
[[http://stackoverflow.com/questions/8146313/emacs-auto-save-for-org-mode-only][emacs auto save for org-mode only - SO]]
** Modules
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
I dont use the diary, but I do use the clock a lot.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** TODO org-capture - Sacha
*** TODO org-capture-prefill-template
*** TODO org-get-current-refile-location
*** TODO org-create-task
*** TODO helm-prompts me to refile.
*** TODO helm-org-clock-in-and-track-from-refile
* TODO Email
