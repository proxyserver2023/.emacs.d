...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-gcal
    :config
    (require 'org-gcal)
    (setq org-gcal-client-id "1097756207487-lv3ccg6q51f2bhvvmi5hml8jat9aoa0u.apps.googleusercontent.com"
          org-gcal-client-secret "ZSnJVBs4TJ5pU-Ja8xNofh3r"
...
# | File      | Purpose              |
# |-----------+----------------------|
# | organizer | main org file        |
# | investor  | investments          |
# | connector | people related tasks |
# | goals     | goals                |
# | remember  | daily read           |
# | blog      | blogging             |
