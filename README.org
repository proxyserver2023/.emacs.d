...
Seems that =C-c @= is too obnoxious to use, So I'll put my favourite on the =C-c h= prefix:
#+begin_src emacs-lisp
  (global-set-key (kbd "C-c T h") 'hs-minor-mode)
  (global-set-key (kbd "C-c f a") 'ha/hs-hide-all)
  (global-set-key (kbd "C-c f s") 'ha/hs-show-all)
  (global-set-key (kbd "C-c f h") 'ha/hs-toggle-hiding)
